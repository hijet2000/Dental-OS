...
const Complaints: FC<{ complaints: Complaint[] }> = ({ complaints }) => {
    ...
    const handleTriage = async () => {
        ...
        try {
            const result = await aiOrchestrationService.runTask<{ category: string; severity: string; actionPlan: string[] }, 'COMPLAINT_TRIAGE'>('COMPLAINT_TRIAGE', { description: newComplaint });
